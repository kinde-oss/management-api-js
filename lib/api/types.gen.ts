...
export type GetApiKeysData = {
   ...
   */
  keyType?: ("organization" | "user") | null;
  /**
...
export type GetApiKeysResponse = get_api_keys_response;
...
export type CreateApiKeyResponse = create_api_key_response;
...
export type GetApiKeyResponse = get_api_key_response;
...
export type DeleteApiKeyResponse = success_response;
...
export type RotateApiKeyResponse = rotate_api_key_response;
...
export type VerifyApiKeyResponse = verify_api_key_response;
...
export type AddOrganizationUsersResponse = add_organization_users_response;
